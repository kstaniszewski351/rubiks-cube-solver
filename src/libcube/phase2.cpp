...
const std::vector<Move> phase_2_moves{U, U2, UP, D, D2, DP, R2, L2, F2, B2};
...
Phase2::Phase2()
    : corner_perm_moves_(&corner_perm_gen_, phase_2_moves),
      ...
      corner_perm_ud_slice_perm_pruning(
          {&corner_perm_moves_, &ud_slice_perm_moves_},
          {&corner_perm_gen_, &ud_slice_perm_gen_}, phase_2_moves.size()),
      ud_perm_ud_slice_perm_pruning({&ud_perm_moves_, &ud_slice_perm_moves_},
